...
Mobile.setText(findTestObject('Object Repository/Transfer/Transfer Antar Bank/Isi Nomor Rekening'), '12345667891', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Transfer/SKN RTGS/input nama'), 0)

Mobile.setText(findTestObject('Transfer/SKN RTGS/input nama'), 'Kakashi', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Transfer/SKN RTGS/input email'), 0)

Mobile.setText(findTestObject('Transfer/SKN RTGS/input email'), 'surgandaalif@gmail,com', 0)
...
Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Transfer\\Transfer SKN\\tambah tujuan.png', 
...
Mobile.setText(findTestObject('Transfer/SKN RTGS/nominal'), '15000', 0)
...
Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Transfer\\Transfer SKN\\konfirmasi transfer.png', 
    FailureHandling.STOP_ON_FAILURE)
...
Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Transfer\\Transfer SKN\\resi.png', 
    FailureHandling.STOP_ON_FAILURE)
