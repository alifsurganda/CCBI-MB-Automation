...
Mobile.getText(findTestObject('Transfer/SKN RTGS/RTGS alert kurang batas minimal'), 0)

Mobile.delay(3, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Transfer\\Transfer RTGS\\kurang batas minimum transfer.png', 
