...
Mobile.setText(findTestObject('Pembayaran/Pascabayar/Field Nomor Handphone'), '0856123455', 0)
...
Mobile.getText(findTestObject('Pembayaran/Pascabayar/nomor hp tidak valid'), 0)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\Pascabayar\\Invalid Nomor Pelanggan.png', 
...
Mobile.clearText(findTestObject('Pembayaran/Pascabayar/Field Nomor Handphone'), 0)
...
Mobile.tap(findTestObject('Pembayaran/Pascabayar/Ubah Rekening Sumber'), 0)

Mobile.tap(findTestObject('Pembayaran/Internet/tabungan3'), 0)
...
Mobile.getText(findTestObject('Pembayaran/Pascabayar/saldo kurang'), 0)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\Pascabayar\\Saldo Tidak Cukup.png', 
    FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Pembayaran/Internet/tabungan1'), 0)
...
Mobile.getText(findTestObject('Pembayaran/Pascabayar/invalid pin'), 0)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\Pascabayar\\Invalid PIN.png', 
    FailureHandling.CONTINUE_ON_FAILURE)
