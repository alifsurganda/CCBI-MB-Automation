...
Mobile.tap(findTestObject('Pembayaran/MPN/cek status'), 0)
...
Mobile.tap(findTestObject('Pembayaran/MPN/Button cek status'), 0)

WebUI.delay(4)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\MPN\\cek status.png', 
