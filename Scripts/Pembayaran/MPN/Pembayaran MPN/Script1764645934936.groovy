...
Mobile.tap(findTestObject('Pembayaran/MPN/transaksi'), 0)
...
Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\MPN\\resi.png', 
    FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Pembayaran/MPN/button kembali beranda'), 0)
