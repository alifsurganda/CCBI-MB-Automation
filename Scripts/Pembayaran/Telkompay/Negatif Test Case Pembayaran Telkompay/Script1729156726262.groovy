...
Mobile.getText(findTestObject('Pembayaran/Telkompay/id pelanggan tidak valid'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\Telkompay\\Invalid ID Pelanggan.png', 
    FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tapAtPosition(514, 1400)

Mobile.tap(findTestObject('Pembayaran/Telkompay/Field ID Pelanggan'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Pembayaran/Telkompay/saldo kurang'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\Telkompay\\Saldo Tidak Cukup.png', 
    FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Pembayaran/Telkompay/invalid pin'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\Telkompay\\Invalid PIN.png', 
    FailureHandling.CONTINUE_ON_FAILURE)
