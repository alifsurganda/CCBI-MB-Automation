...
Mobile.setText(findTestObject('Pembayaran/PDAM/Field ID Pelangggan'), '6033433', 0)
...
Mobile.getText(findTestObject('Pembayaran/PDAM/id pelanggan ga valid'), 0)

WebUI.delay(2)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\PDAM\\Invalid ID Pelanggan.png', 
...
Mobile.tap(findTestObject('Pembayaran/PDAM/Ubah Rekening Sumber'), 0)
...
Mobile.getText(findTestObject('Pembayaran/PDAM/saldo kurang'), 0)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\PDAM\\Saldo Tidak Cukup.png', 
    FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Pembayaran/PDAM/0'), 0)
...
Mobile.getText(findTestObject('Pembayaran/PDAM/invalid pin'), 0)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\PDAM\\Invalid PIN.png', 
    FailureHandling.CONTINUE_ON_FAILURE)
