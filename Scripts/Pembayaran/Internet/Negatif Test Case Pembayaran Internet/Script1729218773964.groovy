...
Mobile.setText(findTestObject('Pembayaran/Telkompay/Field ID Pelanggan'), '127369', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Pembayaran/Telkompay/Button Selanjutnya'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Pembayaran/Internet/id pelanggan tidak valid'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\Internet\\Invalid ID Pelanggan.png', 
...
Mobile.clearText(findTestObject('Pembayaran/Telkompay/Field ID Pelanggan'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Pembelian/Paket Data/4'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Pembelian/Paket Data/7'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Pembayaran/Telkompay/2'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Pembelian/Paket Data/5'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.tap(findTestObject('Pembelian/Paket Data/8'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.getText(findTestObject('Pembayaran/Internet/saldo kurang'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\Internet\\Saldo Tidak Cukup.png', 
    FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.getText(findTestObject('Pembayaran/Internet/invalid pin'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.takeScreenshot('C:\\Users\\dwida\\Documents\\Project Alif\\CCBI\\Katalon\\Automation Mobile Banking V3 DSI\\Screenshoot\\Pembayaran\\Internet\\Invalid PIN.png', 
    FailureHandling.CONTINUE_ON_FAILURE)
